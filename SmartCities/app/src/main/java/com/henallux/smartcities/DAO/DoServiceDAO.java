...
public class DoServiceDAO extends GenericDAO implements IDoServiceDAO
{
    ...
    private ArrayList<DoService> jsonToDoServices(String stringJSON) throws ConnectionException
    {
        try {
    ...
    private String doServiceToJson(DoService doService) throws ConnectionException
    {
        try {
    ...
    private String doServiceCommentToJson(DoService doService) throws ConnectionException
    {
        try {
            JSONObject jsonDoService = new JSONObject();
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
